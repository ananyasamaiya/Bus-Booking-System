document.addEventListener('DOMContentLoaded', () => {
    ...
    const layout_json = {
        ...
        seats: [
            ...
            { id: 'L11', type: 'sleeper', row: 6, col: 1, ladies: true }, 
    ...
    const reserved_seats = [
        ...
        { id: 'L11', status: 'occupied', ladies: true }
    ];
    ...
    function renderSeats() {
        ...
        for (let r = 1; r <= layout_json.configuration.rows; r++) {
            for (let c = 1; c <= layout_json.configuration.columns; c++) {
                ...
                const seatData = layout_json.seats.find(s => s.row === r && s.col === c);
                ...
                if (seatData) {
                    ...
                    if (reservation) {
                        ...
                        if (reservation.ladies) {
                            seatEl.classList.add('ladies');
                        }
                    } else if (seatData.ladies) {
                        seatEl.classList.add('ladies');
                    }
